...
<Responsive as={Segment} style={{padding: 0, margin: 0, backgroundColor:'#7881ff'}} minWidth={1170}>
  <Grid className="App" style={{margin: 0, backgroundColor:'#7881ff'}} verticalAlign="bottom">
      ...
      <Grid.Column width={1}>
        <Icon as={Dropdown} style={{fontSize: "2em", color:'white'}} icon="bars" size='mini' >
          <Dropdown.Menu>
            ...
            <Dropdown.Item text="Make flashcards" />
          </Dropdown.Menu>
        </Icon>
      </Grid.Column>
      <Grid.Column width={2}>
    ...
    <Button inverted as={Grid.Column} floated="right" onClick={() => this.logout()} width={1}>
      Logout
    </Button>
  </Grid.Row>
</Grid>
